			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
		                ...
		                <ul>
		                	<li>
		                		<a href="user-profile.php" class="ttr-material-button"><span class="ttr-label">Student</span></a>
		                	</li>
		                	<li>
		                		<a href="teacher-profile.php" class="ttr-material-button"><span class="ttr-label">Teacher</span></a>
		                	</li>
		                </ul>
		            </li>
					...
					<li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><i class="ti-user"></i></span>
		                	<span class="ttr-label">search user</span>
		                	<span class="ttr-arrow-icon"><i class="fa fa-angle-down"></i></span>
		                </a>
		                <ul>
		                	<li>
